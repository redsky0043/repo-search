        ...
        debouncedQuery && debouncedQuery.length >= 3 ? (
          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-4">
              ...
              {data && <span className="text-gray-500 text-sm ml-2">({data.pages[0]?.total_count || 0} found)</span>}
            </h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-600 py-12 text-center">Find repositories on GitHub</h2>
        )
      )}
    </section>
  )
